...
- [x] RPC prompt preflight, model-aware header-auth checks for prompt/model selection paths, bash `excludeFromContext`, `get_session_stats.contextUsage`, and child-exit pending-request rejection.
